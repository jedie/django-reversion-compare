...
from reversion_compare_project.models import Car, Factory, Person
...
class FactoryCarReverseRelationModelTest(BaseTestCase):
    ...
    def test_select_compare(self):
        response = self.client.get(f"/en/admin/reversion_compare_project/factory/{self.factory.pk}/history/")
    ...
    def test_diff1(self):
        response = self.client.get(
            f"/en/admin/reversion_compare_project/factory/{self.factory.pk}/history/compare/",
