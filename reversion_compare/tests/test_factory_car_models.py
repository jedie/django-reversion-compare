...
from reversion_compare_project.models import Car, Factory
...
class FactoryCarModelTest(BaseTestCase):
    ...
    def test_select_compare(self):
        response = self.client.get(f"/en/admin/reversion_compare_project/car/{self.car.pk}/history/")
    ...
    def test_diff1(self):
        response = self.client.get(
            f"/en/admin/reversion_compare_project/car/{self.car.pk}/history/compare/",
...
class FactoryCarModelTest2(BaseTestCase):
    ...
    def test_deleted_objects(self):
        ...
        # response = self.client.get("/admin/reversion_compare_project/car/%s/history/" % car.pk)
        # debug_response(response) # from django-tools
        self.client.get(
            f"/en/admin/reversion_compare_project/car/{car.pk}/history/compare/",
